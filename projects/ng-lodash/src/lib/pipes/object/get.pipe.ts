...
export class GetPipe implements PipeTransform {
  ...
  public transform<TObject extends object, TKey extends keyof TObject, TDefault>(
    object: TObject | null | undefined,
    path: TKey | [TKey],
  ...
  public transform<T>(object: _.NumericDictionary<T> | null | undefined, path: number): T | undefined;
  ...
  public transform<TDefault>(object: null | undefined, path: _.PropertyPath, defaultValue: TDefault): TDefault;
